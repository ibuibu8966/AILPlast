      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12 fade-in">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-white">
            <span className="inline-block">AIを使って</span><span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent whitespace-nowrap">何ができる</span><span className="inline-block">のか？</span>
          </h2>
          <p className="text-gray-300 text-xs sm:text-sm md:text-base px-2">
            <span className="inline-block">すぐに使える</span><span className="text-cyan-400 font-bold whitespace-nowrap">業務効率化</span><span className="inline-block">から、</span><span className="inline-block">本格的な</span><span className="text-blue-400 font-bold whitespace-nowrap">自動化システム構築</span><span className="inline-block">まで</span>
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto fade-in">
          {/* 日常業務の効率化カード */}
          <div className="bg-gray-800/80 backdrop-blur-md border border-cyan-500/30 rounded-2xl p-8 hover:bg-gray-800/90 transition-all duration-300">
